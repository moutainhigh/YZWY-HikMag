package com.example.yzwy.lprmag.guide.animation.guide;
...
import com.example.yzwy.lprmag.MainActivity;
import com.example.yzwy.lprmag.R;
import com.example.yzwy.lprmag.WelcomeActivity;
import com.example.yzwy.lprmag.guide.animation.arcanimator.ArcAnimator;
import com.example.yzwy.lprmag.guide.animation.arcanimator.Side;
import com.example.yzwy.lprmag.guide.animation.utils.DensityUtil;
import com.example.yzwy.lprmag.guide.animation.viewpager.CirclePageIndicator;
import com.example.yzwy.lprmag.guide.animation.viewpager.PagerAdapter;
...
//        pageThreeInit();
        ...
        page_three_go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Tools.Intent(GuideActivity.this, LoginActivity.class);
            }
        });
...
//        view3 = LayoutInflater.from(this).inflate(R.layout.layout_guide_three, null);
        ...
        view1 = LayoutInflater.from(this).inflate(R.layout.ly_guide_1, null);
        view2 = LayoutInflater.from(this).inflate(R.layout.ly_guide_2, null);
        view3 = LayoutInflater.from(this).inflate(R.layout.ly_guide_3, null);
