package com.example.yzwy.lprmag.wifimess.lprthread;
...
//            socket.c
        ...
        handler.sendEmptyMessage(LprDialog.DEVICE_CONNECTED);
        try {
            //获取数据流
            ...
            while (true) {
                ...
                if (bytes > 0) {
                    ...
                    message.what = LprDialog.GET_MSG;
        ...
        if (outputStream != null) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    Log.i("ConnectThread", "发送消息：" + msg);
                    Message message = Message.obtain();
                    message.what = LprDialog.SEND_MSG_SUCCSEE;
                    Bundle bundle = new Bundle();
                    bundle.putString("MSG", new String(msg));
                    message.setData(bundle);
                    handler.sendMessage(message);
...
//                e.printStackTrace();
//                Message message = Message.obtain();
//                message.what = com.xx.yzwy.dialog.LprDialog.SEND_MSG_ERROR;
//                Bundle bundle = new Bundle();
